...
public final class CardIOActivity extends Activity {
    ...
    /**
     * Boolean extra. Optional. If this value is set to <code>true</code> flash will be set into auto mode and toggle
     * flash button will disappear.
     */
    public static final String EXTRA_SET_FLASH_MODE_AUTO = "io.card.payment.AutoFlashMode";

    /**
     *  Boolean etra. Optional. If this value is set to <code>true</code> back button will be added to the Activity View.
     */
    public static final String EXTRA_ADD_BACK_BUTTON = "io.card.payment.AddBackButton";
    ...
    private void addBackButton() {
        ...
        llParams.gravity = Gravity.TOP|Gravity.START;
        relativeLayout.setLayoutParams(llParams);

        ImageView imageView = new ImageView(this);

        RelativeLayout.LayoutParams ivParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT);
        ivParams.setMargins(0, getStatusBarHeight(), 0, 0);
        imageView.setLayoutParams(ivParams);

        imageView.setImageResource(R.drawable.ic_action_navigation_arrow_back_inverted);
        int imageViewSize = getActionBarSize();
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setMaxHeight(imageViewSize);
        imageView.setMinimumHeight(imageViewSize);
        imageView.setMaxWidth(imageViewSize);
        imageView.setMinimumWidth(imageViewSize);
        ...
        linearLayout.addView(mMainLayout);
    ...
    private int getActionBarSize() {
        return getResources().getDimensionPixelSize(R.dimen.cio_actionbar_size);
    }
    ...
    private void setPreviewLayout() {
        ...
        if (getIntent() != null) {
            ...
            boolean hideToggleFlashButton = getIntent().getBooleanExtra(EXTRA_SET_FLASH_MODE_AUTO, false);
            if (Util.deviceSupportsTorch(this) && hideToggleFlashButton) {
                mOverlay.setTorchButtonVisibility(false);
                mCardScanner.setAutoFlashOn(true);
            }
        ...
        boolean addBackButton = getIntent().getBooleanExtra(EXTRA_ADD_BACK_BUTTON, false);
        if (addBackButton) {
            addBackButton();
        }
        else {
