...
public class ToolTip {
    ...
    @IntDef({STANDARD_ARROW, CONVERSATION_ARROW})
    public @interface ArrowStyle {}
    public static final int STANDARD_ARROW = 0;
    public static final int CONVERSATION_ARROW = 1;
    ...
    private @ArrowStyle int mArrowStyle;
    ...
    public ToolTip(Builder builder){
        ...
        mArrowStyle = builder.mArrowStyle;
    ...
    public void setmArrowStyle(int mArrowStyle) {
        this.mArrowStyle = mArrowStyle;
    }
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder setArrowStyle(@ArrowStyle int arrowStyle){
