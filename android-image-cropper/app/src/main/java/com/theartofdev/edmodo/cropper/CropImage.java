...
public final class CropImage {
  ...
  public static final String FILE_PROVIDER_URI = "io.loot.lootapp.utils.fileprovider";
  ...
  public static void startCameraActivity(@NonNull Activity activity) {
    Intent takePictureIntent = getCameraIntent(activity ,null);
    activity.startActivityForResult(takePictureIntent, PICK_IMAGE_CHOOSER_REQUEST_CODE);
  }
  ...
  public static Uri getCaptureImageOutputUri(@NonNull Context context) {
    ...
    if (getImage != null) {
      if (Build.VERSION.SDK_INT >= 24) {
        outputFileUri = FileProvider.getUriForFile(context, FILE_PROVIDER_URI, new File(getImage.getPath(), "pickImageResult.jpeg"));
      } else {
  ...
  public static final class ActivityBuilder {
    ...
    public ActivityBuilder setRunCamera(boolean runCamera) {
      mOptions.runCamera = runCamera;
      return this;
    }

    public ActivityBuilder setSkipCropping(boolean skipCropping) {
      mOptions.skipCropping = skipCropping;
      return this;
    }
  }
  // endregion
