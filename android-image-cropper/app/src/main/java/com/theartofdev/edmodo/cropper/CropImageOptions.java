...
public class CropImageOptions implements Parcelable {
  public static final int OPTIMIZED_HEIGHT = 748;

  public static final int OPTIMIZED_WIDTH = 1024;
  ...
  public CropImageOptions() {
    ...
    outputRequestWidth = OPTIMIZED_WIDTH;
    outputRequestHeight = OPTIMIZED_HEIGHT;
  ...
  protected CropImageOptions(Parcel in) {
    ...
    runCamera = in.readByte() != 0;
    skipCropping = in.readByte() != 0;
  }
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    dest.writeByte((byte) (runCamera ? 1 : 0));
    dest.writeByte((byte) (skipCropping ? 1 : 0));
  }
