...
public class CropImageView extends FrameLayout {
  ...
  public void getCroppedImageAsync(int reqWidth, int reqHeight, RequestSizeOptions options) {
    ...
    startCropWorkerTask(reqWidth, reqHeight, options, null, null, 0, true);
  }
  ...
  public void saveCroppedImageAsync(
    ...
    startCropWorkerTask(
        reqWidth, reqHeight, options, saveUri, saveCompressFormat, saveCompressQuality ,true);
  }


  public void saveStandardImageAsync(
          Uri saveUri,
          Bitmap.CompressFormat saveCompressFormat,
          int saveCompressQuality,
          int reqWidth,
    ...
    startCropWorkerTask(
            reqWidth, reqHeight, options, saveUri, saveCompressFormat, saveCompressQuality, false);
  }
