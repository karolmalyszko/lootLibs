...
public class SwipeConfiguration {
    ...
    // icons background resid
    private int mIconsBackgroundColor = 0;
    // description text
    ...
    Drawable getLeftImageDrawable() {
        return mLeftImageDrawable;
    }
    ...
    Drawable getRightImageDrawable() {
        return mRightImageDrawable;
    }

    void setLeftImageView(ImageView imageView) {
        mLeftIv = imageView;
    }
    ...
    void setRightImageView(ImageView imageView) {
        mRightIv = imageView;
    }
    ...
    int getIconsBackgroundColor() {
        return mIconsBackgroundColor;
    }

    void setIconsBackgroundColor(int color) {
        mIconsBackgroundColor = color;
    }
    ...
    public static class Builder {
        ...
        public Builder setLeftImageDrawable(Drawable drawable) {
            mLeftImageDrawable = drawable;
            return this;
        }
        ...
        public Builder setIconsBackgroundColor(int color) {
            mIconsBackgroundColor = color;
            return this;
        }
        ...
        public Builder setLeftImageView(ImageView imageView) {
            mLeftIv = imageView;
            return this;
        }

        public Builder setRightImageView(ImageView  imageView) {
            mRightIv = imageView;
            return this;
        }
        ...
        public SwipeConfiguration build() {
            ...
            config.setIconsBackgroundColor(mIconsBackgroundColor);
            config.setLeftImageView(mLeftIv);
            config.setRightImageView(mRightIv);
            config.setLeftImageDrawable(mLeftImageDrawable);
            config.setRightImageDrawable(mRightImageDrawable);
